...
A simple web-based digital clock built using HTML, CSS, and JavaScript that displays the current system time and updates automatically every second in real time.
